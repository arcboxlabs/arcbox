...
## [0.8.0](https://github.com/arcboxlabs/arcbox/compare/v0.7.0...v0.8.0) (2026-09-26)
...
* **agent:** attach stdin and host control to piped machine exec ([638a998](https://github.com/arcboxlabs/arcbox/commit/638a9984911e984cce9024464c98e6270e009e86))
* **agent:** drive the publish mirror from Docker container events ([faab65d](https://github.com/arcboxlabs/arcbox/commit/faab65d306a732b6aeda0b1c8a8aa5a0b956fc55))
...
* **agent:** honour machine exec flow control ([e001cde](https://github.com/arcboxlabs/arcbox/commit/e001cde7c16af0abe25da6f04fcd5b86597febbd))
* **agent:** mirror host-address-pinned publishes for the inbound relay ([465821e](https://github.com/arcboxlabs/arcbox/commit/465821e07d1fad9f140f0dbba0a6d3b60ea44267))
...
* **agent:** pick a container domain's HTTP port from what it listens on ([9676968](https://github.com/arcboxlabs/arcbox/commit/967696898d8988193c21e2c2025493a43ce7a358))
* **agent:** read machine exec host frames beside the PTY output pump ([6711d7e](https://github.com/arcboxlabs/arcbox/commit/6711d7e973e069b30f4b90e09d84222ef009b71c))
* **agent:** relay TCP connections from inside the machine ([a3c8ea9](https://github.com/arcboxlabs/arcbox/commit/a3c8ea935af10b227be62889490a2c6ced97f40c))
* **agent:** report the signal that ended a machine exec process ([ccf20dc](https://github.com/arcboxlabs/arcbox/commit/ccf20dc74c61a2b5a60b9de25d3131f2be79d323))
* **agent:** rescan a started container's listeners while its server binds ([85a811e](https://github.com/arcboxlabs/arcbox/commit/85a811eaa77727eeab22b8660db1fd5f77631070))
* **agent:** route a container domain's port 80 to its labelled HTTP port ([5ee5073](https://github.com/arcboxlabs/arcbox/commit/5ee5073a246a10318ad01ae37fbe4505b442f3f9))
* **agent:** run k3s servicelb and list LoadBalancer Services ([d5b441a](https://github.com/arcboxlabs/arcbox/commit/d5b441a0c0eb58cb24f3a9b499d18e55290534c4))
* **agent:** run login machine exec requests as sshd-style sessions ([99be9c5](https://github.com/arcboxlabs/arcbox/commit/99be9c535c8c3a977490162d5b8f5197ed77edf9))
* **agent:** terminate TLS for container domains with the local CA ([00c5b70](https://github.com/arcboxlabs/arcbox/commit/00c5b70a59a4b9fd012c025d5a083732c5d50ec2))
* **api:** serve System VM resources over Connect and abctl ([49cf273](https://github.com/arcboxlabs/arcbox/commit/49cf2730352b18b494182b61b7c0540df9df1018))
* **cli:** add abctl ssh install to include ArcBox's SSH config ([1822555](https://github.com/arcboxlabs/arcbox/commit/1822555a0360bfa1d4d7f84fc5f19f28144aece8))
* **cli:** add abctl tls trust/untrust for the local CA ([8e7380a](https://github.com/arcboxlabs/arcbox/commit/8e7380aff3679ed3757c3b065189bd22af603325))
...
* **core:** forward Kubernetes LoadBalancer ports to the host ([6a09b61](https://github.com/arcboxlabs/arcbox/commit/6a09b61fd38042c56654b7f418ffa5fefc223aec))
...
* **engine:** flow-control machine exec sessions and always drain them ([95021b0](https://github.com/arcboxlabs/arcbox/commit/95021b01d2286bd9be8f630e5bdee878b682d96d))
* **engine:** let the Kubernetes hold be observed ([d92f6bc](https://github.com/arcboxlabs/arcbox/commit/d92f6bcda96c26e0a04a5b6ea513352bc28a732d))
* **engine:** let the System VM's CPU and memory limits change at runtime ([2a2d8ee](https://github.com/arcboxlabs/arcbox/commit/2a2d8ee162dcc301205743d7be61315befbc660c))
* **engine:** open TCP connections inside machines as flow-controlled sessions ([49919a6](https://github.com/arcboxlabs/arcbox/commit/49919a6c670f5a5ed24c18017a44228fdcb8cb17))
...
* **local-ca:** generate a name-constrained CA for container domains ([b362ae5](https://github.com/arcboxlabs/arcbox/commit/b362ae57f65b273b6058c20fd2598eddc8e84b65))
* **local-ca:** mint a certificate per server name from the CA ([068e8cc](https://github.com/arcboxlabs/arcbox/commit/068e8cc5aa70d829c5f8c36e57ed846a633189c5))
* **net:** make guest egress proxying an explicit policy ([1f1d629](https://github.com/arcboxlabs/arcbox/commit/1f1d629928e39abfd2a1abb97b9500f1ac64bc9c)), closes [#315](https://github.com/arcboxlabs/arcbox/issues/315)
* **protocol:** add flow-control windows to machine exec sessions ([099f83a](https://github.com/arcboxlabs/arcbox/commit/099f83a544eb62282fee05b8a3835f6867dcea5f))
* **protocol:** add login, attached-stdin and signal fields to machine exec ([82c73a5](https://github.com/arcboxlabs/arcbox/commit/82c73a58704c36b93887686e5198303661846e08))
* **protocol:** open TCP connections inside machines and mark output EOF ([6e495ff](https://github.com/arcboxlabs/arcbox/commit/6e495ff3862db8990138a6718abb3ed87400b41d))
* **pty:** carry an account's supplementary groups into the privilege drop ([2897308](https://github.com/arcboxlabs/arcbox/commit/28973083ffc46d674a3ad25de0861da03cc931ac))
* **rpc:** add a LoadBalancer Service listing to the agent protocol ([5aaabf6](https://github.com/arcboxlabs/arcbox/commit/5aaabf6d474cbcb8ead01b8a1d0406e26fd93f78))
...
* **ssh:** add the arcbox-ssh crate with its keys and login targets ([01fda00](https://github.com/arcboxlabs/arcbox/commit/01fda00d161743dc3d58f3892602092e7737b093))
* **ssh:** carry signals to session processes and report signal deaths ([9e1b568](https://github.com/arcboxlabs/arcbox/commit/9e1b568d95f59926882f8fd98c4a23228478c921))
* **ssh:** forward direct-tcpip channels to ports inside the machine ([3cad4a3](https://github.com/arcboxlabs/arcbox/commit/3cad4a3eec687be5299728516b19640f8eb8e845))
* **ssh:** honour pty-req, window-change and env in sessions ([a9eb45c](https://github.com/arcboxlabs/arcbox/commit/a9eb45c2f53f2e0d4eaa71147732d9a0192e61b0))
* **ssh:** run shell and exec sessions over the machine exec path ([218262e](https://github.com/arcboxlabs/arcbox/commit/218262e051a70680dfd17e2520aad32e730cbefe))
* **ssh:** serve SSH connections that authenticate with the daemon's key ([ece4247](https://github.com/arcboxlabs/arcbox/commit/ece42476ce6c4398b77a70fcba18d84d5535351a))
* **ssh:** serve the sftp subsystem with the machine's own sftp-server ([264e96d](https://github.com/arcboxlabs/arcbox/commit/264e96d9cc0a3fd844c6d5669a82b07af34348bc))
* **ssh:** write the OpenSSH client config for the server ([cb2c8a4](https://github.com/arcboxlabs/arcbox/commit/cb2c8a420a98757f95173595eeb7da24f35cd156))
...
* **vmm:** return reported guest pages to the host on the HV backend ([8787141](https://github.com/arcboxlabs/arcbox/commit/8787141423db492a84c7552a2604ec9183bb4e92))
...
* **agent:** give sysvinit machines a boot-completion hook ([306da7d](https://github.com/arcboxlabs/arcbox/commit/306da7da71b6638bd103e89794b272f1117a9cfd))
* **agent:** keep the boot-done hook out of systemd's preset policy ([5317190](https://github.com/arcboxlabs/arcbox/commit/53171900c99fbcd858c2d13340bbf8ec2577d5b2))
* **agent:** read machine addresses off the interfaces, not hostname ([9613298](https://github.com/arcboxlabs/arcbox/commit/96132988f63295d5cc684e0ff9343d0b76ca2696))
* **agent:** report Kubernetes ready only once its kubeconfig exists ([b992009](https://github.com/arcboxlabs/arcbox/commit/b992009907aee2ceeaae0e8f2eb219d5b96c60a5))
* **agent:** serve only RPC inside distro machines ([5305f47](https://github.com/arcboxlabs/arcbox/commit/5305f4751fe1499c8802dd9203c41bc9002d6352))
...
* **config:** read the documented ~/.config/arcbox/config.toml ([f250bc4](https://github.com/arcboxlabs/arcbox/commit/f250bc4823908ad07af172bb8a5f1b5273fc0c84))
* **daemon:** boot on the HV backend without asking it for sandbox cleanup ([b2b30f1](https://github.com/arcboxlabs/arcbox/commit/b2b30f1776830f45db61bc2223565d8c01277624))
* **dns:** follow the host resolver across network changes ([e2a46f3](https://github.com/arcboxlabs/arcbox/commit/e2a46f3541f0702f3b799f50406350606e162487)), closes [#714](https://github.com/arcboxlabs/arcbox/issues/714)
* **docker:** carry attach half-close in-band over the vsock channel ([1dad10e](https://github.com/arcboxlabs/arcbox/commit/1dad10e36603af2b8ed5a443071145721b247aa5)), closes [#268](https://github.com/arcboxlabs/arcbox/issues/268)
...
* **engine:** end a machine exec session when its consumer goes away ([ab109d9](https://github.com/arcboxlabs/arcbox/commit/ab109d9a26c7e4748f4bde752abc3667083e5281))
* **engine:** keep kernel NIC names in distro machines ([6684ecc](https://github.com/arcboxlabs/arcbox/commit/6684ecc2a1b43a924fb82861bd0098873f40e9bb))
...
* **ssh:** never hold the connection for input while output needs it ([4d5fd38](https://github.com/arcboxlabs/arcbox/commit/4d5fd38712afb1021560cebc7d4add3880120839))
...
* **daemon:** poll LoadBalancers over one kept agent connection ([6258585](https://github.com/arcboxlabs/arcbox/commit/6258585db4804e3465b2485c81205073b2e974e8))
...
* **agent:** hold container rules as tagged per-container sets ([0243dc5](https://github.com/arcboxlabs/arcbox/commit/0243dc56526fe4b352443f1cd462945dd99ed9bf))
* **agent:** move machine exec exit frames and signalling into session.rs ([a2e05cd](https://github.com/arcboxlabs/arcbox/commit/a2e05cd6a437ce52c3360a6effc7d604ff37a5dd))
* **agent:** move the tagged-rule iptables helpers into their own module ([e846efa](https://github.com/arcboxlabs/arcbox/commit/e846efa963e2abe9eff156dc2e14998ca480ed0b))
* **agent:** resolve machine exec requests into one process spec ([09637e8](https://github.com/arcboxlabs/arcbox/commit/09637e8fc3e65543ef2a8e8de7b0c97613e6b490))
* **agent:** run interactive machine exec sessions through the same loop ([a0e4230](https://github.com/arcboxlabs/arcbox/commit/a0e4230a66c96682854b1fa179b776c7cc9db22f))
* **agent:** run piped machine exec sessions through a channel-fed loop ([5bf1363](https://github.com/arcboxlabs/arcbox/commit/5bf1363cc2090e2a29580d0a113e5272b460c0f9))
* **balloon:** release pages through a host-owned PageReleaser ([8b8f2ac](https://github.com/arcboxlabs/arcbox/commit/8b8f2ac416b65d68e72776c6c5968db64eac6566))
...
* **core:** read host listener owners through one helper ([b67588e](https://github.com/arcboxlabs/arcbox/commit/b67588e9bcd23826173ef5e7d1b36885b02d2a59))
* **engine:** give machine exec sessions an output type of their own ([e86c0e2](https://github.com/arcboxlabs/arcbox/commit/e86c0e21a2d76d81e2d5a8ff8c22d7dea5a145c1))
* **engine:** move machine exec sessions into their own module ([85d0382](https://github.com/arcboxlabs/arcbox/commit/85d03823c042293c6ab8cc29b3e0ff68fec21747))
...
* **agent:** cover machine exec flow-control accounting ([c220169](https://github.com/arcboxlabs/arcbox/commit/c220169880addf2363446d5d81568d6ea8eab3e0))
* **agent:** give the host test build the toml its tests parse ([4221445](https://github.com/arcboxlabs/arcbox/commit/422144540442613b17b04ebcf3d9c58972709130))
* **agent:** relay a TCP peer both ways through its half-closes ([59674fa](https://github.com/arcboxlabs/arcbox/commit/59674faa83e315f8c1b7ff3587fbc89ca35d2938))
...
* **api:** resolve the official-image icon fixture through redis, not nginx ([1d63f6c](https://github.com/arcboxlabs/arcbox/commit/1d63f6c536f47a85486c0744e593883f6889cdf1))
* **balloon:** cover the release seam and host-page alignment ([b8b43a6](https://github.com/arcboxlabs/arcbox/commit/b8b43a6f39be84e217af77397e36cd95e68eef2d))
...
* **core:** cover the Kubernetes LoadBalancer reconcile ([e87e351](https://github.com/arcboxlabs/arcbox/commit/e87e35184e7a2dba6a86e460cea400e0d254865b))
* **e2e:** cover Kubernetes LoadBalancer forwarding to the host ([d4d54b6](https://github.com/arcboxlabs/arcbox/commit/d4d54b6cb92539bc46b8ecb1d8d2861ca6dfa0e9))
* **e2e:** cover stdin EOF in the smoke suite and serve with nc ([beb2289](https://github.com/arcboxlabs/arcbox/commit/beb22895d0a8f931cfc1ed96d2bcb36141d8229a))
* **e2e:** stage every runtime companion asset from the installed app ([c025087](https://github.com/arcboxlabs/arcbox/commit/c025087272c85bad6e9775e6bc73fcd851360010))
* **engine:** drive machine exec flow control against a fake agent ([1133e63](https://github.com/arcboxlabs/arcbox/commit/1133e63b72245b687fd95230fd015a99b52dff12))
...
* **ssh:** drive exec sessions against a scripted machine ([0e96b42](https://github.com/arcboxlabs/arcbox/commit/0e96b424ab5d2566fb2b564d499049e0ea572b50))
* **ssh:** pin down when session input may hold the connection ([b2b69b6](https://github.com/arcboxlabs/arcbox/commit/b2b69b6b4b6b69e5313bb3a3ca66993836f95bbe))
...
* **agent:** describe container domains served without a port ([9604b03](https://github.com/arcboxlabs/arcbox/commit/9604b03f06df4c009c3db7f49db4eb47a4952649))
* **agents:** fold CLAUDE.md into AGENTS.md; land changes on master directly ([d5bf9f3](https://github.com/arcboxlabs/arcbox/commit/d5bf9f35dd15afc545e2ddc93f04cba32fd78493))
* **agents:** record what the distro tests and the parallel work taught ([b122010](https://github.com/arcboxlabs/arcbox/commit/b122010d47f5f0bf1b500f6c06cf952c1147cee3))
...
* describe HTTPS for container domains and abctl tls trust ([f2ca88c](https://github.com/arcboxlabs/arcbox/commit/f2ca88c0f713448d3b1412efa2e64d429dc16836))
...
* **readme:** list the machine distros that work today ([8ca31a6](https://github.com/arcboxlabs/arcbox/commit/8ca31a66e9ad93407d1ab0583d8bcb952592780b))
