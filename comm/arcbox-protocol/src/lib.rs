...
pub mod agent {
    pub use super::v1::{
        AgentPingRequest, AgentPingResponse, K3sEnsureRequest, K3sEnsureResponse,
...
// Agent types
pub use v1::{
    AgentPingRequest, AgentPingResponse, K3sEnsureRequest, K3sEnsureResponse, PortBindingsChanged,
